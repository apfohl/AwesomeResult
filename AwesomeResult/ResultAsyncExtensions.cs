...
namespace AwesomeResult
{
    public static class ResultAsyncExtensions
    {
        ...
        public static async Task<Result<TResult>> Map<T, TResult>(this Task<Result<T>> result, Func<T, TResult> mapping,
            bool continueOnCapturedContext = false) =>
        ...
        public static async Task<Result<TResult>> Map<T, TResult>(this Task<Result<T>> result,
            ...
            await (await result.ConfigureAwait(continueOnCapturedContext)).Map(mapping, continueOnCapturedContext);
        ...
        public static async Task<Result<TResult>> Bind<T, TResult>(this Task<Result<T>> result,
            Func<T, Task<Result<TResult>>> mapping, bool continueOnCapturedContext = false) =>
            await (await result.ConfigureAwait(continueOnCapturedContext)).Bind(mapping, continueOnCapturedContext);
    }
}
